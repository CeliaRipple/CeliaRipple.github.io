...
SET od=W:\week4lab\hydroanalysis\ASTERhydro%pre%
...
saga_cmd grid_tools 3 -GRIDS=W:\week4lab\hydroanalysis\ASTERhydro\ASTGTMV003_S04E037_dem.tif;W:\week4lab\hydroanalysis\ASTERhydro\ASTGTMV003_S03E037_dem.tif -NAME=%pre%Mosaic -TYPE=9 -RESAMPLING=0 -OVERLAP=1 -MATCH=0 -TARGET_OUT_GRID=%od%\%pre%mosaic.sgrd
